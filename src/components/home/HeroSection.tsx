      ...
      <div className="container relative py-20 md:py-32">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance animate-fade-up" style={{ animationDelay: '0.2s' }}>
            Skip the crowded stores. Our specialist brings up to 5 phones to your home for a personalized demo—just ₹499 (₹400 deposit + ₹99 convenience). Deposit refunded on purchase.
          </p>
